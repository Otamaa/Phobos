...
{
	//if (auto pOwner = OwnerObject()->Owner)
	//{
	//	if (auto pManagerOwnerExt = TechnoTypeExt::ExtMap.Find(pOwner->GetTechnoType()))
	//	{
	//		OverloadCount = pManagerOwnerExt->AnotherData.Overload_Count.Get(RulesClass::Instance->OverloadCount);
	//		OverloadFrames = pManagerOwnerExt->AnotherData.Overload_Frames.Get(RulesClass::Instance->OverloadFrames);
	//		OverloadDamage = pManagerOwnerExt->AnotherData.Overload_Damage.Get(RulesClass::Instance->OverloadDamage);
	//		OverloadDeathSound = pManagerOwnerExt->AnotherData.Overload_DeathSound.Get(RulesClass::Instance->MasterMindOverloadDeathSound);
	//	}
	//}
}

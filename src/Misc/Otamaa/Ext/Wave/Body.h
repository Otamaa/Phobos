...
struct SonicBeamDataContainer
{
	...
	Valueable<VelocityClass> SonicBeamStartPinLeft;
	Valueable<VelocityClass> SonicBeamStartPinRight;
	Valueable<VelocityClass> SonicBeamEndPinLeft;
	Valueable<VelocityClass> SonicBeamEndPinRight;
	SonicBeamSurfacePatternType SonicBeamSurfacePattern;
	SonicBeamSinePatternType SonicBeamSinePattern;

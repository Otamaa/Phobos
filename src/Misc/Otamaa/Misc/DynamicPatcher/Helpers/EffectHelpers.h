...
#include <RadBeam.h>
#include <Misc/Otamaa/New/Entity/EboltClass/ElectricBoltClass.h>
...
public:
		...
		, ParticleSystem { nullptr }
	{
		...
		Color1 = ColorStruct(nDraw->MidPoint[IsAlternateColor ? 5 : 10]);
		Color2 = ColorStruct(nDraw->MidPoint[IsAlternateColor ? 5 : 10]);
		Color3 = ColorStruct(nDraw->MidPoint[15]);
	};
...
struct EffectHelpers
{
	...
	static void DrawLine(CoordStruct sourcePos, CoordStruct targetPos, LaserType type, ColorStruct houseColor)
	{
	...
	static void DrawBeam(CoordStruct sourcePos, CoordStruct targetPos, BeamType type, ColorStruct customColor = ColorStruct::Empty)
	{
